...
ECHO "<p class='previewp'>Propriétaire: ".$recup['NOM']." ".$recup['PRENOM']."</p> <p class='previewp'>Tel: ".$recup['TEL']."</p> <br>";
...
if($_SESSION['proprio']==$recup['LOGINpro']){
...
echo "<input class='champs' type='date' name='datevisite'>";
